...
var decodeMethodParams = (abi, data, methodSignatureProvided = true) => {
  ...
  const result = decodeParameters2([...abi.inputs], value);
  return result;
};
