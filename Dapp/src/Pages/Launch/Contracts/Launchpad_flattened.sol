...
contract MadContractsLaunchpad {
    address public defaultTreasuryAddress;
    ...
    constructor(address _defaultTreasuryAddress) {
        defaultTreasuryAddress = _defaultTreasuryAddress;
        tokenCount = 0;
    }
    ...
    function deployMemeToken(
        ...
        TestMemeTaxedToken token = new TestMemeTaxedToken(name, symbol, initialSupply, buyTax, sellTax, transferTax, taxRecipient, treasuryAddress);
        ...
        emit TokenDeployed(address(token), tokenCount, msg.sender, name, symbol, initialSupply, buyTax, sellTax, transferTax, treasuryAddress);
    ...
    function setTreasuryAddress(address newTreasuryAddress) external {
        ...
        address oldAddress = defaultTreasuryAddress;
        defaultTreasuryAddress = newTreasuryAddress;
    ...
    // View function to get the default treasury address
    function getDefaultTreasuryAddress() external view returns (address) {
